  ...
  tier2: [
    {
      ...
      speakers: [
        ...
        },
        {
          name: "千手 孝太郎",
          title: "津南町立津南病院 医師",
          image: "/speakers/senjyu.webp",
          imagePosition: "top",
          profile:
            "関西医科大学卒業後、初期研修を経て津南町立津南病院へ赴任。病気ではなく人を診ることを信念に、総合診療医として外来・入院・救急・在宅医療まで幅広く担当している。地域医療の課題解決に挑む姿勢が評価され、新潟県医師会研修医奨励賞最優秀賞を受賞。現在は総合診療の専門研修を続けながら、院長補佐として病院経営や組織改革にも参画し、持続可能な地域医療体制づくりに取り組んでいる。また、医学生や中高生向けのキャリアイベントを主催するなど、医療の枠を超えた地域づくりにも尽力。「医療に詳しい まちのお兄ちゃん」を目指し、地域に根ざした医療を実践している。狂言師やライターとしての顔も持つ。",
        },
        {
          name: "野﨑 涼",
          title:
            "コラボレイティブ・ガバナンス研究社会連携講座　研究員（PwCコンサルティング合同会社 マネージャー）",
          image: "/speakers/nozaki.jpg",
          profile:
        ...
        {
          name: "長橋 幸宏",
          title: "株式会社LONGBRIDGE代表／石高プロジェクト運営事務局",
          image: "/speakers/nagahashi.jpg",
          profile:
            "1991年、東京都生まれ。2022年より福島県西会津町の地域おこし協力隊に就任。在任中に始まった「石高プロジェクト」の運営事務局として、農村と都市をつなぐ仕組みづくりに携わる。協力隊の任期を経て同町で起業し、地域を起点とした様々な活動を行っている。2025年には、古民家を改装した喫茶店「POSSIBLE COFFEE」を開業。地域の内と外の対流をもとに、故くて新しい持続可能な地域のあり方を模索している。",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      speakers: [
        ...
        },
        {
          name: "篠崎 亮",
          title:
            "コラボレイティブ・ガバナンス研究社会連携講座　研究員（PwCコンサルティング合同会社 ディレクター）",
          image: "/speakers/shinozaki.png",
          profile:
        ...
        },
        {
          name: "藤沢 久美",
          title: "国際社会経済研究所理事長",
          image: "/speakers/fujisawa.webp",
          imagePosition: "top",
          profile:
            "国内外の投資運用会社勤務を経て、1995年に日本初の投資信託評価会社株式会社アイフィスを起業。1999年、同社を世界的格付会社スタンダード＆プアーズに売却。2000年にシンクタンク・ソフィアバンクの設立に参画。その後は政府審議会委員や証券業協会公益理事、公立大学法人役員を歴任し、トヨタ自動車、メルカリ、しずおかFGなど上場企業の社外取締役も兼務。2022年4月、NECグループの独立シンクタンク国際社会経済研究所理事長に就任。",
        },
      ],
    },
  ],
